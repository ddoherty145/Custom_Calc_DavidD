...
width = input("Enter an Number for Width: ")
length = input("Enter a Number for Length: ")
volume = int(length) * int(width) * int(height)
print( f" A Cube with the Height of {height}, Width of {width}, and Length of {length} has a volume of {volume}.")
